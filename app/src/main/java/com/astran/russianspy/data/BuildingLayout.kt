...
object BuildingLayout {
    ...
    val rooms = listOf(
        ...
        Room("hall_entrance", "", RoomFunction.HALLWAY, x = 2200f, y = 2370f, width = 100f, height = 460f),

        Room("meeting_room", "Sala de Intalniri", RoomFunction.MEETING_ROOM, x = 2100f, y = 1400f, width = 300f, height = 300f),
        Room("hall_meeting", "", RoomFunction.HALLWAY, x = 2200f, y = 1670f, width = 100f, height = 360f),

        Room("office1", "Birouri", RoomFunction.OFFICE, x = 1300f, y = 2050f, width = 350f, height = 250f),
        Room("hall_office1", "", RoomFunction.HALLWAY, x = 1620f, y = 2100f, width = 410f, height = 100f),

        Room("office2", "Birouri 2", RoomFunction.OFFICE, x = 700f, y = 2080f, width = 300f, height = 200f),
        Room("hall_office2", "", RoomFunction.HALLWAY, x = 970f, y = 2120f, width = 360f, height = 100f),
        ...
        Room("hall_server", "", RoomFunction.HALLWAY, x = 3000f, y = 1320f, width = 100f, height = 710f),

        Room("armory", "Armurerie", RoomFunction.ARMORY, x = 2900f, y = 500f, width = 300f, height = 250f),
        Room("hall_armory", "", RoomFunction.HALLWAY, x = 3000f, y = 720f, width = 100f, height = 410f),

        Room("break_room", "Camera Pauza", RoomFunction.BREAK_ROOM, x = 2900f, y = 2100f, width = 350f, height = 250f),
        Room("hall_break", "", RoomFunction.HALLWAY, x = 2470f, y = 2150f, width = 460f, height = 100f),

        Room("comms", "Monitorizare Comunicatii", RoomFunction.COMMS_MONITOR, x = 3350f, y = 1950f, width = 300f, height = 250f),
        Room("hall_comms", "", RoomFunction.HALLWAY, x = 3250f, y = 2000f, width = 150f, height = 100f)
    )
